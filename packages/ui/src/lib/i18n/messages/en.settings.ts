export const settingsDict = {
  ...
  'settings.openchamber.sessionRetention.applicationCache.title': 'Application Cache',
  'settings.openchamber.sessionRetention.applicationCache.actions.clear': 'Clear Cache',
  'settings.openchamber.sessionRetention.applicationCache.actions.clearing': 'Clearing Cache…',
  'settings.openchamber.sessionRetention.applicationCache.state.size': 'Cache size: {size}',
  'settings.openchamber.sessionRetention.applicationCache.state.loadingSize': 'Calculating cache size…',
  'settings.openchamber.sessionRetention.applicationCache.state.sizeUnavailable': 'Cache size unavailable',
  'settings.openchamber.sessionRetention.applicationCache.toast.cleared': 'Application cache cleared',
  'settings.openchamber.sessionRetention.applicationCache.toast.clearFailed': 'Could not clear application cache',
