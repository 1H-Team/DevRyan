export const settingsDict = {
  ...
  'settings.agents.limits.title': 'Sub-Agent Limits',
  'settings.agents.limits.concurrent.label': 'Concurrent Sub-Agents',
  'settings.agents.limits.concurrent.description': 'How many sub-agents may run at the same time, host-wide (1 to 16).',
  'settings.agents.limits.pressure.label': 'Pause New Sub-Agents Under Memory Pressure',
  'settings.agents.limits.pressure.description': 'Under critical memory pressure no new sub-agent starts until it eases; under elevated pressure the limit is halved. Running sub-agents are never stopped.',
  'settings.agents.limits.pressure.status': 'Memory pressure: {state}',
  'settings.agents.limits.pressure.state.normal': 'normal',
  'settings.agents.limits.pressure.state.elevated': 'elevated',
  'settings.agents.limits.pressure.state.critical': 'critical',
  'settings.agents.limits.readOnly.on': 'On',
  'settings.agents.limits.readOnly.off': 'Off',
  'settings.agents.limits.toast.loadFailed': 'Failed to load sub-agent limits',
  'settings.agents.limits.toast.saveFailed': 'Failed to save sub-agent limits',
