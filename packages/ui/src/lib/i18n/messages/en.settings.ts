export const settingsDict = {
  ...
  'settings.openchamber.about.diagnostics.clearAll': 'Clear All Data',
  'settings.openchamber.about.diagnostics.clearing': 'Clearing Data…',
  'settings.openchamber.about.diagnostics.cleared': 'Diagnostic data cleared',
  'settings.openchamber.about.diagnostics.clearFailed': 'Failed to clear diagnostic data',
  ...
  'settings.openchamber.about.diagnostics.clearDialog.title': 'Clear All Diagnostic Data?',
  'settings.openchamber.about.diagnostics.clearDialog.description': 'This permanently removes the diagnostic journal for all sessions stored on this device. Chat history is unaffected. This action cannot be undone.',
