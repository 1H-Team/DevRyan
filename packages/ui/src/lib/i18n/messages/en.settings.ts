export const settingsDict = {
  ...
  'settings.openchamber.about.opencode.description': 'Compare the active runtime with the latest stable release and this DevRyan build.',
  ...
  'settings.openchamber.about.opencode.state.upToDate': 'The active OpenCode runtime is up to date.',
