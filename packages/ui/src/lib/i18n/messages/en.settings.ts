export const settingsDict = {
  ...
  'settings.providers.page.auth.openCodeZenUsageDescription': '1. Open opencode.ai/workspace in a browser and select your workspace.\n2. Copy the wrk_… value from the billing page URL.\n3. In browser DevTools, copy only the Value of the auth cookie for opencode.ai.',
  'settings.providers.page.auth.openCodeZenWorkspaceIdPlaceholder': 'Workspace ID (wrk_…)',
  'settings.providers.page.auth.openCodeZenAuthCookiePlaceholder': 'auth cookie value',
