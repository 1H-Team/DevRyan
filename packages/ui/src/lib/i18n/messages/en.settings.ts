export const settingsDict = {
  ...
  'settings.view.home.cards.providers.description': 'Connect providers and review usage limits',
  ...
  'settings.view.home.cards.mcp.title': 'MCP Servers',
  ...
  'settings.page.remoteConnections.title': 'Remote Connections',
  'settings.page.providers.title': 'Providers',
  'settings.page.usage.title': 'Usage',
  'settings.providers.tabs.aria': 'Provider settings',
  'settings.remoteConnections.tabs.aria': 'Remote connection settings',
  'settings.page.bots.title': 'Bots',
  'settings.page.bots.description': 'Published assistants, membership, permissions, and lifecycle.',
  ...
  'settings.page.bugReports.title': 'Bug Reports',
  'settings.page.bugReports.description': 'Submit product issues and review managed diagnostics.',
  'settings.bugReports.tabs.submit': 'Submit Bug Report',
  'settings.bugReports.tabs.reports': 'Bug Reports',
  'settings.bugReports.tabs.agentAudit': 'Agent Audit',
  'settings.bugReports.tabs.botAudit': 'Bot Audit',
  'settings.bugReports.botAudit.title': 'Bot Audit',
  'settings.bugReports.botAudit.description': 'Review immutable, content-free operational and security outcomes for production Bots.',
  'settings.bugReports.botAudit.filter.action': 'Filters',
  'settings.bugReports.botAudit.filter.active': 'Filters, {count} Active',
  'settings.bugReports.botAudit.filter.menuLabel': 'Filter Bot Audit',
  'settings.bugReports.botAudit.filter.reset': 'Reset Filters',
  'settings.bugReports.botAudit.result.label': 'Result',
  'settings.bugReports.botAudit.result.issues': 'Issues',
  'settings.bugReports.botAudit.result.failure': 'Failure',
  'settings.bugReports.botAudit.result.partial': 'Partial',
  'settings.bugReports.botAudit.result.unknown': 'Unknown',
  'settings.bugReports.botAudit.result.denied': 'Denied',
  'settings.bugReports.botAudit.result.success': 'Success',
  'settings.bugReports.botAudit.result.all': 'All Results',
  'settings.bugReports.botAudit.bot.label': 'Bot',
  'settings.bugReports.botAudit.bot.all': 'All Bots',
  'settings.bugReports.botAudit.bot.deleted': 'Deleted Bot',
  'settings.bugReports.botAudit.user.label': 'User',
  'settings.bugReports.botAudit.user.all': 'All Users',
  'settings.bugReports.botAudit.date.label': 'Range',
  'settings.bugReports.botAudit.date.range24h': 'Past 24 hours',
  'settings.bugReports.botAudit.date.range7d': 'Past 7 days',
  'settings.bugReports.botAudit.date.range30d': 'Past 30 days',
  'settings.bugReports.botAudit.date.all': 'All Time',
  'settings.bugReports.botAudit.pageSize': 'Per Page',
  'settings.bugReports.botAudit.search.placeholder': 'Search actions, targets, or diagnostic codes',
  'settings.bugReports.botAudit.loading': 'Loading Bot audit…',
  'settings.bugReports.botAudit.empty': 'No Bot issues have been captured.',
  'settings.bugReports.botAudit.filteredEmpty': 'No Bot audit events match these filters.',
  'settings.bugReports.botAudit.loadMore': 'Load More',
  'settings.bugReports.botAudit.loadingMore': 'Loading…',
  'settings.bugReports.botAudit.back': 'Back to Bot Audit',
  'settings.bugReports.botAudit.eventId': 'Event ID',
  'settings.bugReports.botAudit.action': 'Action',
  'settings.bugReports.botAudit.target': 'Target',
  'settings.bugReports.botAudit.occurred': 'Occurred',
  'settings.bugReports.botAudit.diagnosticCode': 'Diagnostic code',
  'settings.bugReports.botAudit.resolved': 'Resolved',
  'settings.bugReports.botAudit.resolvedAt': 'Resolved at',
  'settings.bugReports.botAudit.resolvedBy': 'Resolved by event ID',
  'settings.bugReports.botAudit.correlation': 'Correlation identifiers',
  'settings.bugReports.botAudit.metadata': 'Validated metadata',
  'settings.bugReports.botAudit.metadataRedacted': 'This event contained invalid legacy metadata. Its metadata was redacted for safety.',
  'settings.bugReports.botAudit.copyContext': 'Copy Bot Context',
  'settings.bugReports.botAudit.contextCopied': 'Bot context copied',
  'settings.bugReports.botAudit.clear.confirmRecent': 'Clear Bot Audit entries from {range} for all administrators, regardless of filters? Retained audit records remain accessible by event ID.',
  'settings.bugReports.botAudit.clear.confirmAll': 'Clear all Bot Audit entries for all administrators, regardless of filters? Retained audit records remain accessible by event ID.',
  'settings.bugReports.botAudit.clear.success': 'Cleared {count} Bot Audit entries',
  'settings.bugReports.botAudit.clear.range24h': 'Past 24 hours',
  'settings.bugReports.botAudit.clear.range7d': 'Past 7 days',
  'settings.bugReports.botAudit.clear.range30d': 'Past 30 days',
  'settings.bugReports.botAudit.clear.rangeAll': 'All Bot Audit entries',
  'settings.bugReports.submit.title': 'Submit a bug report',
  'settings.bugReports.submit.description': 'Describe what went wrong. DevRyan records your account details automatically.',
  'settings.bugReports.submit.field.title': 'Title',
  'settings.bugReports.submit.field.titlePlaceholder': 'Short summary of the problem',
  'settings.bugReports.submit.field.description': 'Description',
  'settings.bugReports.submit.field.descriptionPlaceholder': 'What happened, what you expected, and how to reproduce it',
  'settings.bugReports.submit.characterCount': '{count} / {maximum}',
  'settings.bugReports.submit.action': 'Submit Bug Report',
  'settings.bugReports.submit.submitting': 'Submitting…',
  'settings.bugReports.submit.success': 'Bug report submitted',
  'settings.bugReports.submit.editRequired': 'Edit permission is required to submit a bug report.',
  'settings.bugReports.reports.title': 'Submitted reports',
  'settings.bugReports.reports.description': 'Review reports and move them through the investigation workflow.',
  'settings.bugReports.reports.filter.label': 'Status',
  'settings.bugReports.reports.filter.all': 'All Statuses',
  'settings.bugReports.reports.loading': 'Loading bug reports…',
  'settings.bugReports.reports.empty': 'No bug reports match this status.',
  'settings.bugReports.reports.loadMore': 'Load More',
  'settings.bugReports.reports.loadingMore': 'Loading…',
  'settings.bugReports.reports.back': 'Back to Bug Reports',
  'settings.bugReports.reports.reporter': 'Reporter',
  'settings.bugReports.reports.created': 'Submitted',
  'settings.bugReports.reports.updated': 'Last updated',
  'settings.bugReports.reports.descriptionLabel': 'Description',
  'settings.bugReports.reports.statusLabel': 'Status',
  'settings.bugReports.reports.savingStatus': 'Saving status…',
  'settings.bugReports.reports.statusUpdated': 'Bug report status updated',
  'settings.bugReports.status.submitted': 'Submitted',
  'settings.bugReports.status.inProgress': 'In Progress',
  'settings.bugReports.status.resolved': 'Resolved',
  'settings.bugReports.errors.title': 'Error logs',
  'settings.bugReports.errors.description': 'Sanitized failures captured from sessions, tools, DevRyan-managed tasks, and browser crashes. Reported text may still contain user content.',
  'settings.bugReports.errors.filter.action': 'Filters',
  'settings.bugReports.errors.filter.active': 'Filters, {count} Active',
  'settings.bugReports.errors.filter.menuLabel': 'Filter Error Logs',
  'settings.bugReports.errors.filter.label': 'Kind',
  'settings.bugReports.errors.filter.all': 'All Kinds',
  'settings.bugReports.errors.filter.reset': 'Reset Filters',
  'settings.bugReports.errors.clear.action': 'Clear',
  'settings.bugReports.errors.clear.menuLabel': 'Clear Error Logs',
  'settings.bugReports.errors.clear.range24h': 'Past 24 hours',
  'settings.bugReports.errors.clear.range7d': 'Past 7 days',
  'settings.bugReports.errors.clear.range14d': 'Past 14 days',
  'settings.bugReports.errors.clear.rangeAll': 'All error logs',
  'settings.bugReports.errors.clear.confirmRecent': 'Clear error logs from {range}? This cannot be undone.',
  'settings.bugReports.errors.clear.confirmAll': 'Clear all error logs? This cannot be undone.',
  'settings.bugReports.errors.clear.success': 'Cleared {count} error logs',
  'settings.bugReports.errors.impactFilter.label': 'Impact',
  'settings.bugReports.errors.impactFilter.all': 'All Impacts',
  'settings.bugReports.errors.disposition.label': 'Disposition',
  'settings.bugReports.errors.disposition.actionable': 'Actionable',
  'settings.bugReports.errors.disposition.expected': 'Expected',
  'settings.bugReports.errors.disposition.all': 'All',
  'settings.bugReports.errors.dateFilter.label': 'Range',
  'settings.bugReports.errors.dateFilter.range24h': 'Past 24 hours',
  'settings.bugReports.errors.dateFilter.range7d': 'Past 7 days',
  'settings.bugReports.errors.dateFilter.range30d': 'Past 30 days',
  'settings.bugReports.errors.dateFilter.all': 'All Time',
  'settings.bugReports.errors.userFilter.label': 'User',
  'settings.bugReports.errors.userFilter.all': 'All Users',
  'settings.bugReports.errors.pageSize.label': 'Per Page',
  'settings.bugReports.errors.search.placeholder': 'Search failure text, tool, or error name',
  'settings.bugReports.errors.search.noResults': 'No captured diagnostics match this search.',
  'settings.bugReports.errors.occurrences': '{count}×',
  'settings.bugReports.errors.kind.session': 'Session',
  'settings.bugReports.errors.kind.tool': 'Tool',
  'settings.bugReports.errors.kind.managedTask': 'Managed Task',
  'settings.bugReports.errors.kind.client': 'Client',
  'settings.bugReports.errors.impact.low': 'Low',
  'settings.bugReports.errors.impact.medium': 'Medium',
  'settings.bugReports.errors.impact.high': 'High',
  'settings.bugReports.errors.impact.critical': 'Critical',
  'settings.bugReports.errors.classification': 'Classification',
  'settings.bugReports.errors.failureClass': 'Failure class',
  'settings.bugReports.errors.outcome': 'Outcome',
  'settings.bugReports.errors.inferred': 'Inferred',
  'settings.bugReports.errors.outcome.recovered': 'Recovered',
  'settings.bugReports.errors.outcome.unresolved': 'Unresolved',
  'settings.bugReports.errors.outcome.unknown': 'Recovery Unknown',
  'settings.bugReports.errors.loading': 'Loading error logs…',
  'settings.bugReports.errors.empty': 'No captured diagnostics match these filters.',
  'settings.bugReports.errors.loadMore': 'Load More',
  'settings.bugReports.errors.loadingMore': 'Loading…',
  'settings.bugReports.errors.back': 'Back to Error Logs',
  'settings.bugReports.errors.eventId': 'Event ID',
  'settings.bugReports.errors.action': 'Action',
  'settings.bugReports.errors.occurred': 'Occurred',
  'settings.bugReports.errors.actor': 'User',
  'settings.bugReports.errors.project': 'Project',
  'settings.bugReports.errors.session': 'Session',
  'settings.bugReports.errors.failureText': 'Failure text',
  'settings.bugReports.errors.stack': 'Stack trace',
  'settings.bugReports.errors.context': 'Agent context',
  'settings.bugReports.errors.copyContext': 'Copy Agent Context',
  'settings.bugReports.errors.contextCopied': 'Agent context copied',
  'settings.bugReports.errors.exportDiagnostics': 'Export Task Diagnostics',
  'settings.bugReports.errors.exportedDiagnostics': 'Exported {fileName}',
  'settings.bugReports.errors.noDiagnostics': 'No session is available for a task-scoped diagnostics export.',
  'settings.bugReports.common.retry': 'Retry',
  ...
  'settings.plugins.sidebar.group.devryanDefaults': 'DevRyan Default Plugins',
  ...
  'settings.plugins.sidebar.kind.includedVersion': '{version} · Included',
  'settings.plugins.sidebar.kind.includedBundled': 'Bundled · Included',
  ...
  'settings.plugins.slim.title': 'Slim Runtime',
  'settings.plugins.slim.field.status': 'Status',
  'settings.plugins.slim.field.version': 'Version',
  'settings.plugins.slim.field.wrapper': 'Wrapper',
  'settings.plugins.slim.field.background': 'Background Agents',
  'settings.plugins.slim.field.backups': 'Backups',
  'settings.plugins.slim.status.ready': 'Ready',
  'settings.plugins.slim.status.needsSetup': 'Needs setup',
  'settings.plugins.slim.status.loading': 'Checking...',
  'settings.plugins.slim.value.configured': 'Configured',
  'settings.plugins.slim.value.missing': 'Missing',
  'settings.plugins.slim.action.install': 'Install Slim',
  'settings.plugins.slim.action.installing': 'Installing...',
  'settings.plugins.slim.action.repair': 'Repair Slim',
  'settings.plugins.slim.action.repairing': 'Repairing...',
  ...
  'settings.plugins.default.badge': 'Included with DevRyan',
  'settings.plugins.default.readOnly': 'This default plugin is installed and managed by DevRyan.',
  'settings.plugins.default.section.package': 'DevRyan Package',
  'settings.plugins.default.field.shippedSpec': 'Shipped Spec',
  'settings.plugins.default.field.effectiveSpec': 'Effective Spec',
  'settings.plugins.default.field.version': 'Version',
  'settings.plugins.default.field.delivery': 'Delivery',
  'settings.plugins.default.field.source': 'Source',
  'settings.plugins.default.value.bundled': 'Bundled',
  'settings.plugins.default.value.npm': 'Preinstalled npm package',
  'settings.plugins.default.value.installedLocal': 'Installed locally (no runtime fetch)',
  'settings.plugins.default.value.curatedSkills': 'Bundled curated skill runtime',
  'settings.plugins.default.value.bundledFile': 'Bundled runtime file',
  ...
  'settings.openchamber.tunnel.note.multiUserConnectSignIn': 'On multi-user hosts, this link opens DevRyan sign-in and never bypasses account access or project assignments.',
  'settings.openchamber.tunnel.note.managedRemoteDirectLogin': 'Managed Remote uses the stable public hostname and DevRyan sign-in directly. No one-time access link is created.',
  'settings.openchamber.tunnel.managedAccountRequired.title': 'Managed accounts required',
  'settings.openchamber.tunnel.managedAccountRequired.description': 'Configure Supabase-backed individual accounts before starting Managed Remote. A shared UI password cannot identify or isolate remote developers.',
  ...
  'settings.openchamber.tunnel.note.stableOriginRelay': 'DevRyan keeps this address stable and relays it to the app\'s current port.',
  ...
  'settings.openchamber.tunnel.note.startManagedRemoteDirectLogin': 'Start the managed tunnel, then open its stable hostname and sign in to DevRyan normally. Do not close the app while this tunnel is in use.',
  ...
  'settings.openchamber.tunnel.field.originPortLabel': 'Fixed Origin Port',
  'settings.openchamber.tunnel.field.originPortPlaceholder': 'Origin port (default 3000)',
  'settings.openchamber.tunnel.field.originMapping': 'Origin Mapping',
  ...
  'settings.openchamber.tunnel.field.publicUrlDirectHint': 'Public URL (opens DevRyan sign-in)',
  ...
  'settings.openchamber.tunnel.actions.restartTunnel': 'Restart Tunnel',
  'settings.openchamber.tunnel.actions.retryConnection': 'Retry Connection',
  'settings.openchamber.tunnel.actions.openCustomDomain': 'Open Custom Domain',
  'settings.openchamber.tunnel.actions.copyUrl': 'Copy URL',
  ...
  'settings.openchamber.tunnel.state.cloudflareConnected': 'Cloudflare connected',
  'settings.openchamber.tunnel.state.devRyanReady': 'DevRyan ready',
  'settings.openchamber.tunnel.state.devRyanStarting': 'DevRyan Starting…',
  'settings.openchamber.tunnel.state.devRyanStartingHint': 'Cloudflare remains connected while DevRyan starts or restarts. New connection links will be available when OpenCode is ready.',
  'settings.openchamber.tunnel.state.tunnelDegraded': 'Public tunnel unavailable',
  'settings.openchamber.tunnel.state.tunnelDegradedHint': 'Cloudflare is not currently reaching this DevRyan instance. Retry after checking the connector or network.',
  'settings.openchamber.tunnel.state.transportProtocol': 'Connector transport',
  'settings.openchamber.tunnel.state.lastVerified': 'Public reachability verified',
  'settings.openchamber.tunnel.state.originRelayActive': 'Loopback relay active; Cloudflare does not need to follow app port changes.',
  'settings.openchamber.tunnel.state.originDirect': 'DevRyan is already running on the configured Cloudflare origin port; no relay is needed.',
  'settings.openchamber.tunnel.diagnostic.code': 'Diagnostic code',
  'settings.openchamber.tunnel.diagnostic.hostname': 'Hostname',
  'settings.openchamber.tunnel.diagnostic.localOrigin': 'DevRyan local origin',
  'settings.openchamber.tunnel.diagnostic.cloudflareOrigin': 'Cloudflare service target',
  'settings.openchamber.tunnel.diagnostic.activeOrigin': 'DevRyan active origin',
  'settings.openchamber.tunnel.diagnostic.managedRemoteOriginMismatch': 'Cloudflare remote ingress for this hostname must route to the configured fixed origin {origin}.',
  'settings.openchamber.tunnel.diagnostic.startupLog': 'Recent cloudflared output',
  ...
  'settings.openchamber.tunnel.toast.invalidOriginPort': 'Origin port must be an integer between 1024 and 65535.',
  ...
  'settings.openchamber.tunnel.toast.publicUrlCopied': 'Public URL copied',
  ...
  'settings.common.actions.hide': 'Hide',
  ...
  'settings.openchamber.about.title': 'About',
  'settings.openchamber.about.field.version': 'Version',
  'settings.openchamber.about.field.currentVersion': 'DevRyan {version}',
  ...
  'settings.openchamber.about.opencode.title': 'OpenCode version',
  'settings.openchamber.about.opencode.field.current': 'Active',
  'settings.openchamber.about.opencode.field.latest': 'Latest Stable',
  'settings.openchamber.about.opencode.field.supported': 'DevRyan Supported',
  'settings.openchamber.about.opencode.actions.check': 'Check for Updates',
  'settings.openchamber.about.opencode.actions.retry': 'Retry',
  'settings.openchamber.about.opencode.state.notChecked': 'Not checked',
  'settings.openchamber.about.opencode.state.checking': 'Checking the latest stable release…',
  'settings.openchamber.about.opencode.state.updateAvailable': 'OpenCode {version} is available.',
  'settings.openchamber.about.opencode.state.newerThanLatest': 'The active runtime is newer than the latest stable release.',
  'settings.openchamber.about.opencode.state.currentUnavailable': 'The active OpenCode version could not be determined.',
  'settings.openchamber.about.opencode.state.unknown': 'Unknown',
  'settings.openchamber.about.opencode.support.supported': 'The active runtime matches the version supported by this DevRyan build.',
  'settings.openchamber.about.opencode.support.older': 'The active runtime is older than the version supported by this DevRyan build.',
  'settings.openchamber.about.opencode.support.newer': 'The active runtime is newer than the version supported by this DevRyan build.',
  ...
  'settings.openchamber.about.diagnostics.cacheLine': 'Application cache: {size}',
  'settings.openchamber.about.diagnostics.cacheLoading': 'Calculating application cache size…',
  'settings.openchamber.about.diagnostics.cacheUnavailable': 'Application cache size unavailable',
  'settings.openchamber.about.diagnostics.export': 'Export Diagnostics',
  'settings.openchamber.about.diagnostics.exported': 'Exported {fileName}',
  'settings.openchamber.about.diagnostics.failed': 'Failed to export diagnostics',
  'settings.openchamber.about.diagnostics.clearLogs': 'Clear Logs',
  'settings.openchamber.about.diagnostics.clearRange.24h': 'Past 24 Hours',
  'settings.openchamber.about.diagnostics.clearRange.7d': 'Past 7 Days',
  'settings.openchamber.about.diagnostics.clearRange.14d': 'Past 14 Days',
  'settings.openchamber.about.diagnostics.clearRange.all': 'All Logs',
  'settings.openchamber.about.diagnostics.clearing': 'Clearing Logs…',
  'settings.openchamber.about.diagnostics.cleared': 'Error logs cleared',
  'settings.openchamber.about.diagnostics.clearFailed': 'Failed to clear error logs',
  'settings.openchamber.about.diagnostics.clearPartialFailed': 'The diagnostic journal was cleared, but the application cache could not be cleared',
  'settings.openchamber.about.diagnostics.clearDialog.title': 'Clear Error Logs?',
  'settings.openchamber.about.diagnostics.clearDialog.rangeLabel': 'Time Range',
  'settings.openchamber.about.diagnostics.clearDialog.rangeAria': 'Error Log Time Range',
  'settings.openchamber.about.diagnostics.clearDialog.description': 'This permanently removes diagnostic entries from {range}. Chat history is unaffected. This action cannot be undone.',
  'settings.openchamber.about.diagnostics.clearDialog.descriptionDesktop': 'This permanently removes the diagnostic journal for all sessions and the Electron/Chromium application cache stored on this device. Chat history is unaffected. This action cannot be undone.',
  ...
  'settings.agents.page.toast.modelOverrideSavedRuntimeWarning': 'Saved, but runtime did not apply it yet',
  ...
  'settings.agents.page.toast.modelOverrideResetRuntimeWarning': 'Reset, but runtime did not apply it yet',
  ...
  'settings.agents.page.actions.saveBackupModel': 'Save Backup',
  'settings.agents.page.actions.clearBackupModel': 'Clear Backup',
  'settings.agents.page.toast.backupModelSaved': 'Backup model saved',
  'settings.agents.page.toast.backupModelSaveFailed': 'Failed to save backup model',
  'settings.agents.page.toast.backupModelCleared': 'Backup model cleared',
  ...
  'settings.agents.runtime.toast.loadFailed': 'Failed to load agent runtime settings',
  'settings.agents.runtime.toast.saveFailed': 'Failed to save agent runtime settings',
  'settings.agents.runtime.toast.restartRequested': 'Agent runtime restart requested. It restarts once active chats finish.',
  'settings.agents.runtime.toast.restartFailed': 'Failed to restart the agent runtime',
  ...
  'settings.agents.page.field.backupModel': 'Backup Model',
  'settings.agents.page.field.backupModelTooltip': 'Used only when the primary model hits a provider usage limit',
  'settings.agents.page.field.backupModelNone': 'None',
  ...
  'settings.behavior.page.title': 'Global Agent Behavior',
  ...
  'settings.behavior.page.loadFailed': 'Couldn\'t load global AGENTS.md.',
  'settings.behavior.page.actions.retry': 'Retry',
  'settings.behavior.page.unavailable.title': 'Global AGENTS.md is unavailable',
  'settings.behavior.page.section.responseStyle': 'Rationale Display',
  'settings.behavior.page.responseStyle.tooltip': 'Sets how much provider-supplied rationale a new conversation displays. The selected level is captured with the first message and does not expose private chain-of-thought.',
  'settings.behavior.page.responseStyle.preset': 'Rationale Display Level',
  'settings.behavior.page.responseStyle.option.provider': 'Provider Default',
  'settings.behavior.page.responseStyle.option.actions': 'Actions Only',
  'settings.behavior.page.responseStyle.option.concise': 'Concise Rationale',
  'settings.behavior.page.responseStyle.option.detailed': 'Detailed Rationale',
  'settings.behavior.page.responseStyle.description.provider': 'Use the provider and model defaults without adding DevRyan rationale instructions.',
  'settings.behavior.page.responseStyle.description.actions': 'Show the action or status for each major step without a separate explanation.',
  'settings.behavior.page.responseStyle.description.concise': 'Add one sentence explaining why each major action is the right next step.',
  'settings.behavior.page.responseStyle.description.detailed': 'Show a short explanation of the evidence, rationale, and relevant tradeoffs before major actions.',
  'settings.behavior.page.toast.loadResponseStyleFailed': 'Failed to load response style settings',
  'settings.behavior.page.toast.saved': 'Global AGENTS.md saved',
  'settings.behavior.page.toast.savedRuntimeWarning': 'Global AGENTS.md saved with a warning',
  'settings.behavior.page.toast.saveFailed': 'Failed to save global AGENTS.md',
  ...
  'settings.skills.sidebar.field.searchPlaceholder': 'Search skills...',
  'settings.skills.sidebar.search.clearAria': 'Clear Skill Search',
  'settings.skills.sidebar.search.matchCount': '{count} of {total}',
  'settings.skills.sidebar.search.empty.title': 'No Matching Skills',
  'settings.skills.sidebar.search.empty.description': 'Try a different name, folder or keyword',
  'settings.skills.sidebar.badge.opencode': 'opencode',
  'settings.skills.sidebar.badge.agents': 'agents',
  'settings.skills.sidebar.toast.skillHidden': 'Skill "{name}" hidden — restore it anytime from Skills Catalog',
  'settings.skills.sidebar.toast.hideSkillFailed': 'Failed to hide skill',
  'settings.skills.sidebar.toast.skillDeleted': 'Skill "{name}" permanently deleted',
  'settings.skills.sidebar.toast.deleteSkillFailed': 'Failed to permanently delete skill',
  ...
  'settings.skills.sidebar.actions.menuAria': 'Actions for Skill "{name}"',
  'settings.skills.sidebar.actions.hideAria': 'Hide Skill "{name}"',
  'settings.skills.sidebar.actions.removeAria': 'Permanently Delete Skill "{name}"',
  'settings.skills.sidebar.deleteDialog.title': 'Permanently Delete Skill',
  'settings.skills.sidebar.deleteDialog.description': 'Permanently delete "{name}"? Its skill directory and files will be deleted and cannot be restored.',
  ...
  'settings.skills.page.actions.openPath': 'Open',
  ...
  'settings.skills.page.toast.openPathFailed': 'Failed to open skill location',
  ...
  'settings.openchamber.sessionRetention.archivedOnly': 'Only clean up archived sessions (age starts at archive time)',
  'settings.openchamber.sessionRetention.skipped': 'Session cleanup was skipped',
  'settings.openchamber.sessionRetention.title': 'Data Retention',
  'settings.openchamber.sessionRetention.tooltip': 'Manage how inactive sessions and local app data are retained. Automatic session cleanup keeps the 5 most recent sessions.',
  ...
  'settings.openchamber.sessionRetention.manualCleanup.eligibleArchiveNow': 'Local archive candidates: {count}. The server checks eligibility before cleanup.',
  'settings.openchamber.sessionRetention.manualCleanup.eligibleDeleteNow': 'Local deletion candidates: {count}. The server checks eligibility before cleanup.',
  ...
  'settings.openchamber.storage.title': 'OpenCode Storage',
  'settings.openchamber.storage.loading': 'Reading OpenCode storage…',
  'settings.openchamber.storage.missing': 'No OpenCode database was found on this host.',
  'settings.openchamber.storage.schemaMismatch': 'The OpenCode database layout is not the one DevRyan knows; maintenance stays off.',
  'settings.openchamber.storage.unavailable': 'OpenCode storage details are unavailable: {error}',
  'settings.openchamber.storage.summary': 'Database {size} (+ {wal} WAL) · {events} events · {reclaimable} reclaimable',
  'settings.openchamber.storage.orphans': '{count} events belong to deleted sessions',
  'settings.openchamber.storage.lastRun.never': 'No cleanup has run yet. Cleanup runs before every OpenCode launch.',
  'settings.openchamber.storage.lastRun.ok': 'Last cleanup {when}: removed {events} events ({before} → {after}){vacuum}',
  'settings.openchamber.storage.lastRun.vacuumed': ', compacted',
  'settings.openchamber.storage.lastRun.partial': ', stopped at the time budget',
  'settings.openchamber.storage.lastRun.skipped': 'Last cleanup {when} was skipped: {reason}',
  'settings.openchamber.storage.lastRun.error': 'Last cleanup {when} failed: {reason}',
  'settings.openchamber.storage.dryRun.result': 'Dry run: {events} events would be removed ({orphans} from deleted sessions, {idle} from {sessions} idle sessions); compaction {vacuum}.',
  'settings.openchamber.storage.dryRun.vacuumYes': 'would run',
  'settings.openchamber.storage.dryRun.vacuumNo': 'would be skipped ({reason})',
  'settings.openchamber.storage.autoDisabled': 'Automatic cleanup before launch is turned off in settings.json (opencodeDbMaintenance.enabled).',
  'settings.openchamber.storage.external': 'Compaction is only available for the OpenCode runtime DevRyan manages on this host.',
  'settings.openchamber.storage.pending': 'Compaction is scheduled; the agent runtime is restarting.',
  'settings.openchamber.storage.running': 'Maintenance is running…',
  'settings.openchamber.storage.actions.dryRun': 'Dry Run',
  'settings.openchamber.storage.actions.compact': 'Compact Now',
  'settings.openchamber.storage.actions.compacting': 'Compacting…',
  'settings.openchamber.storage.dialog.title': 'Compact OpenCode Storage?',
  'settings.openchamber.storage.dialog.description': 'This removes event history DevRyan never reads (deleted sessions, and sessions idle for more than {hours} hours keep only their newest {keep} entries), then rebuilds the database file to reclaim about {reclaimable}. The agent runtime restarts, which interrupts every running session. Chat history is unaffected.',
  'settings.openchamber.storage.dialog.confirm': 'Compact',
  'settings.openchamber.storage.toast.scheduled': 'Compaction scheduled; the agent runtime is restarting',
  'settings.openchamber.storage.toast.completed': 'OpenCode storage compacted',
  'settings.openchamber.storage.toast.completedDescription': 'Removed {events} events, {before} → {after}',
  'settings.openchamber.storage.toast.dryRunFailed': 'Dry run failed',
  'settings.openchamber.storage.toast.compactFailed': 'Compaction could not be scheduled',
  'settings.openchamber.storage.vacuumReason.not_requested': 'not requested',
  'settings.openchamber.storage.vacuumReason.other_opencode_process': 'another OpenCode process is running',
  'settings.openchamber.storage.vacuumReason.free_disk_unknown': 'free disk space is unknown',
  'settings.openchamber.storage.vacuumReason.insufficient_free_disk': 'not enough free disk space',
  'settings.openchamber.storage.vacuumReason.freelist_below_threshold': 'too little reclaimable space',
  'settings.openchamber.storage.vacuumReason.time_budget_exhausted': 'the time budget was exhausted',
  'settings.openchamber.storage.vacuumReason.not_evaluated': 'not evaluated',
  'settings.openchamber.storage.reason.missing_database': 'no database',
  'settings.openchamber.storage.reason.schema_mismatch': 'unknown database layout',
  'settings.openchamber.storage.reason.no_sqlite_driver': 'no SQLite driver on this host',
  ...
  'settings.openchamber.desktopKeepAwake.title': 'Keep Awake',
  'settings.openchamber.desktopKeepAwake.field.enabledAria': 'Keep Awake',
  'settings.openchamber.desktopKeepAwake.field.enabled': 'Keep the Display Awake While DevRyan Is Open',
  'settings.openchamber.desktopKeepAwake.field.description': 'Prevents display sleep while the desktop app is running.',
  'settings.openchamber.desktopKeepAwake.error.loadFailed': 'Failed to load keep-awake setting',
  'settings.openchamber.desktopKeepAwake.error.saveFailed': 'Failed to save keep-awake setting',
  'settings.openchamber.desktopKeepAwake.toast.applyFailed': 'Saved, but failed to apply Keep Awake immediately',
  'settings.openchamber.agentBrowserControl.title': 'Agent Browser Control',
  'settings.openchamber.agentBrowserControl.field.enabledAria': 'Agent Browser Control',
  'settings.openchamber.agentBrowserControl.field.enabled': 'Let Agents Drive the Browser Panel',
  'settings.openchamber.agentBrowserControl.field.description': 'Agent browser leases start hidden and appear here only when you choose to observe one. Each lease uses a separate local-only capability.',
  'settings.openchamber.agentBrowserControl.error.loadFailed': 'Failed to load agent browser control setting',
  'settings.openchamber.agentBrowserControl.error.saveFailed': 'Failed to save agent browser control setting',
  'settings.openchamber.agentBrowserControl.toast.applyFailed': 'Saved, but failed to apply Agent Browser Control immediately',
  'settings.openchamber.agentBrowserControl.installer.expectedVersion': 'Expected version',
  'settings.openchamber.agentBrowserControl.installer.installedVersion': 'Installed version',
  'settings.openchamber.agentBrowserControl.installer.activeLeases': 'Active browser sessions',
  'settings.openchamber.agentBrowserControl.installer.status': 'Browser tool status',
  'settings.openchamber.agentBrowserControl.installer.loading': 'Checking…',
  'settings.openchamber.agentBrowserControl.installer.preparing': 'Preparing managed runtime…',
  'settings.openchamber.agentBrowserControl.installer.external': 'External runtime (not managed)',
  'settings.openchamber.agentBrowserControl.installer.ready': 'Ready',
  'settings.openchamber.agentBrowserControl.installer.needsRepair': 'Needs repair',
  'settings.openchamber.agentBrowserControl.installer.missing': 'Not installed',
  'settings.openchamber.agentBrowserControl.installer.repair': 'Repair browser tool',
  'settings.openchamber.agentBrowserControl.installer.repairing': 'Repairing…',
  'settings.openchamber.agentBrowserControl.installer.error.statusFailed': 'Failed to check the browser tool installation',
  'settings.openchamber.agentBrowserControl.installer.error.repairFailed': 'Failed to repair the browser tool installation',
  'settings.openchamber.agentBrowserControl.installer.toast.repaired': 'Browser tool repaired',
  'settings.openchamber.agentBrowserControl.installer.skillConflict': 'Your customized agent-browser skill was preserved and could not be updated automatically.',
  'settings.openchamber.agentBrowserControl.installer.skillError': 'The managed agent-browser skill needs attention.',
  ...
  'settings.projects.evidence.title': 'Turn evidence',
  'settings.projects.evidence.toggle': 'Save workspace changes for each turn',
  'settings.projects.evidence.description': 'Captures the workspace state before and after each turn. Records show workspace changes observed during this turn and may include your edits, external processes, or overlapping sessions. They are evidence only—never restore points or attribution.',
  'settings.projects.evidence.cursorNote': 'Off by default. Cursor-runtime sessions have no OpenCode snapshots, so this is their only exact capture path.',
  'settings.projects.evidence.loadFailed': 'Failed to load turn evidence settings',
  'settings.projects.evidence.saveFailed': 'Failed to save turn evidence settings',
  'settings.projects.evidence.clear': 'Clear Saved Evidence',
  'settings.projects.evidence.clearing': 'Clearing…',
  'settings.projects.evidence.cleared': 'Cleared {count} saved checkpoints',
  'settings.projects.evidence.clearFailed': 'Failed to clear saved evidence',
  'settings.projects.evidence.clearDialog.title': 'Clear saved turn evidence?',
  'settings.projects.evidence.clearDialog.description': 'This permanently removes the hidden evidence refs and checkpoint records for this project. It does not change your branch, HEAD, index, or working files.',
  'settings.projects.processes.title': 'Background processes',
  'settings.projects.processes.toggle': 'Track background processes started by agents',
  'settings.projects.processes.description': 'When on, shell commands run by agents carry a session marker so their processes can be grouped and stopped when the session is deleted.',
  'settings.projects.processes.note': 'Off by default. Only dev servers matched to a deleted session are stopped automatically; everything else stays until you stop it from the Processes tab.',
  'settings.projects.processes.loadFailed': 'Failed to load process tracking settings',
  'settings.projects.processes.saveFailed': 'Failed to save process tracking settings',
  'settings.usage.sidebar.title': 'Usage',
  'settings.usage.sidebar.total': 'Total {count}',
  'settings.usage.sidebar.actions.toggleAutoRefreshAria': 'Toggle Faster Auto Refresh',
  'settings.usage.sidebar.actions.refreshAria': 'Refresh Usage',
  'settings.usage.sidebar.actions.refreshTitle': 'Refresh Usage',
  'settings.usage.sidebar.tooltip.autoRefresh': 'Refresh more frequently than the automatic 30-minute baseline',
  ...
  'settings.usage.page.state.providerWarningTitle': 'Provider usage warning',
  'settings.usage.page.state.claudeUsagePendingTitle': 'Claude Code usage pending',
  'settings.usage.page.state.claudeUsagePendingDescription': 'DevRyan is refreshing Claude Code usage automatically. If this persists, check that Claude Code is installed and authenticated.',
  'settings.usage.page.state.claudeSessionLimitTitle': 'Claude Code usage limit reached',
  ...
  'settings.providers.page.auth.checkingClaudeCliDescription': 'Checking Claude Code authentication without making a model request.',
  'settings.providers.page.auth.checkingClaudeCliTitle': 'Checking Claude Code',
  'settings.providers.page.auth.claudeCliMissingDescription': 'Install Claude Code, then refresh and sign in to your Anthropic account.',
  'settings.providers.page.auth.claudeCliMissingTitle': 'Claude Code is not installed',
  'settings.providers.page.auth.claudeInstallTerminalLabel': 'Install Claude Code',
  'settings.providers.page.auth.claudeLoginDescription': 'Sign in with Claude Code, then refresh this status.',
  'settings.providers.page.auth.claudeLoginTerminalLabel': 'Claude Code Login',
  'settings.providers.page.auth.claudeLoginTitle': 'Claude Code sign-in required',
  'settings.providers.page.auth.claudeAuthenticatedDescription': 'Claude Code is signed in. Configure the unofficial OpenCode proxy to use this subscription.',
  'settings.providers.page.auth.claudeAuthenticatedTitle': 'Claude Code authenticated',
  'settings.providers.page.auth.claudeStatusErrorDescription': 'DevRyan could not read Claude Code authentication status. Refresh or sign in again.',
  'settings.providers.page.auth.claudeStatusErrorTitle': 'Claude Code status unavailable',
  ...
  'settings.providers.page.auth.cursorCredentialMode': 'Cursor Credential Type',
  'settings.providers.page.auth.cursorDashboardMode': 'Dashboard Session',
  'settings.providers.page.auth.cursorOAuthMode': 'OAuth Tokens',
  'settings.providers.page.auth.cursorOAuthDescription': 'Enter an OAuth access token, refresh token, or both. These quota credentials remain separate from the Cursor SDK execution key.',
  'settings.providers.page.auth.cursorAccessTokenPlaceholder': 'OAuth access token (optional)',
  'settings.providers.page.auth.cursorRefreshTokenPlaceholder': 'OAuth refresh token (optional)',
  'settings.providers.page.auth.ollamaCloudUsageTitle': 'Ollama Cloud usage tracking',
  'settings.providers.page.auth.ollamaCloudUsageDescription': 'Paste the authenticated cookie value from ollama.com. DevRyan validates it before storing a private managed copy.',
  'settings.providers.page.auth.ollamaCloudCookiePlaceholder': 'Ollama Cloud cookie',
  'settings.providers.page.auth.openCodeZenUsageTitle': 'OpenCode Zen usage tracking',
  'settings.providers.page.auth.openCodeZenUsageDescription': 'Sign in with OpenCode Console and choose the workspace whose Zen balance and monthly spend to track.',
  'settings.providers.page.auth.openCodeZenConnected': 'Connected',
  'settings.providers.page.auth.openCodeZenNotConnected': 'Not connected',
  'settings.providers.page.auth.openCodeZenAwaitingApproval': 'Approve DevRyan on the OpenCode Console page that opened and choose your workspace. Confirm this code matches:',
  'settings.providers.page.auth.openCodeZenReconnectRequired': 'OpenCode moved Zen billing to the OpenCode Console, so the saved workspace ID and auth cookie no longer work. Reconnect to resume usage tracking.',
  'settings.providers.page.auth.openCodeZenDenied': 'Sign-in was denied in OpenCode Console.',
  'settings.providers.page.auth.openCodeZenExpired': 'The sign-in code expired. Start again.',
  'settings.providers.page.auth.managedQuotaChecking': 'Checking...',
  'settings.providers.page.auth.managedQuotaConfigured': 'Managed credential saved',
  'settings.providers.page.auth.managedQuotaNotConfigured': 'Managed credential not saved',
  'settings.providers.page.auth.managedQuotaEffectiveSource': 'Effective source: {source}',
  'settings.providers.page.auth.managedQuotaFallbackPreserved': 'A fallback credential remains available and is not changed when this managed credential is cleared.',
  ...
  'settings.providers.page.auth.oauthWaitingTitle': 'Waiting for authorization',
  'settings.providers.page.auth.oauthWaitingDescription': 'Finish in the browser or device window. DevRyan will continue automatically.',
  'settings.providers.page.auth.oauthLoadingModelsTitle': 'Authorization complete',
  'settings.providers.page.auth.oauthLoadingModelsDescription': 'Reloading OpenCode and loading provider models…',
  'settings.providers.page.auth.oauthErrorTitle': 'Connection not completed',
  'settings.providers.page.auth.oauthRetryHint': 'Select Retry to start again.',
  'settings.providers.page.auth.modelsPendingTitle': 'Connected — models still loading',
  'settings.providers.page.auth.modelsPendingDescription': 'Credentials for {provider} were saved. Models will appear once OpenCode finishes reloading.',
  'settings.providers.page.auth.connected': 'Connected',
  'settings.providers.page.auth.notConnected': 'Not connected',
  'settings.providers.page.auth.connectToUse': '· Connect this provider to use its models',
  ...
  'settings.providers.page.claudeCompatibility.enabled': 'Claude compatibility mode enabled',
  'settings.providers.page.claudeCompatibility.disabled': 'Claude compatibility mode disabled',
  ...
  'settings.providers.page.connectionDetails.source.projectConfig': 'active project config',
  'settings.providers.page.connectionDetails.source.customConfig': 'custom config',
  'settings.providers.page.state.disconnectPending': 'Disconnect pending',
  'settings.providers.page.state.disconnectPendingShort': 'Pending',
  'settings.providers.page.state.disconnectPendingHint': 'The provider will be removed when OpenCode applies the pending configuration.',
  ...
  'settings.providers.page.actions.retry': 'Retry',
  ...
  'settings.providers.page.actions.installClaudeCli': 'Install Claude Code',
  ...
  'settings.providers.page.actions.importFromCursor': 'Import from Cursor',
  'settings.providers.page.actions.importing': 'Importing...',
  ...
  'settings.providers.page.actions.disconnectPending': 'Disconnect Pending',
  ...
  'settings.providers.page.toast.oauthCodeRequired': 'Authorization code is required',
  ...
  'settings.providers.page.toast.claudeCliCheckFailed': 'Failed to check Claude Code status',
  'settings.providers.page.toast.claudeOAuthChecked': 'Claude Code is authenticated and the OpenCode proxy is configured',
  'settings.providers.page.toast.claudeOAuthCheckFailed': 'Failed to configure Claude Code authentication',
  'settings.providers.page.toast.claudeInstallStarted': 'Claude Code install opened in the terminal',
  'settings.providers.page.toast.claudeInstallFailed': 'Failed to open Claude Code install',
  'settings.providers.page.toast.claudeLoginStarted': 'Claude Code sign-in opened in the terminal',
  'settings.providers.page.toast.claudeLoginFailed': 'Failed to open Claude Code sign-in',
  ...
  'settings.providers.page.toast.cursorUsageImported': 'Cursor quota credentials imported',
  'settings.providers.page.toast.managedQuotaStatusFailed': 'Failed to check managed quota credentials',
  'settings.providers.page.toast.managedQuotaMutationFailed': 'Failed to update managed quota credentials',
  'settings.providers.page.toast.managedQuotaValidationSucceeded': 'Quota credentials validated',
  'settings.providers.page.toast.managedQuotaRefreshFailed': 'Credentials are saved, but usage could not be refreshed. Try Refresh Usage again.',
  'settings.providers.page.toast.managedQuotaSaved': 'Managed quota credentials saved',
  'settings.providers.page.toast.managedQuotaCleared': 'Managed quota credentials cleared',
  'settings.providers.page.toast.openCodeZenConnected': 'OpenCode Zen usage tracking connected',
  'settings.providers.page.toast.openCodeZenStartFailed': 'Failed to start OpenCode Console sign-in',
  'settings.providers.page.toast.managedQuotaValidated': 'Quota credentials validated and usage refreshed',
  ...
  'settings.github.accountManagement.adminRequired': 'A DevRyan administrator must assign a GitHub account in User Management.',
  ...
  'settings.notifications.page.events.planReadyAria': 'Plan Ready',
  'settings.notifications.page.events.planReadyLabel': 'Plan Ready',
  ...
  'settings.notifications.page.events.permissionAria': 'Permissions Needed',
  'settings.notifications.page.events.permissionLabel': 'Permissions Needed',
  ...
  'settings.notifications.page.template.event.completion': 'Session Completion',
  'settings.notifications.page.template.event.planReady': 'Plan Ready',
  ...
  'settings.notifications.page.template.event.permission': 'Permissions Needed',
  'settings.notifications.page.template.field.title': 'Title',
  'settings.notifications.page.template.field.message': 'Message',
  'settings.notifications.page.template.defaults.completion.title': 'Session complete',
  'settings.notifications.page.template.defaults.completion.message': '{session_name} is ready to review',
  'settings.notifications.page.template.defaults.planReady.title': 'Plan ready',
  'settings.notifications.page.template.defaults.planReady.message': 'A plan is ready for review',
  ...
  'settings.notifications.page.template.defaults.permission.title': 'Permissions needed',
  'settings.notifications.page.template.defaults.permission.message': 'Folder access is required: {last_message}',
  ...
  'settings.voice.page.tooltip.sttBrowser': 'Web Speech API. May depend on an online service supplied by the browser.',
  ...
  'settings.voice.page.stt.wasmPrivacyHint': 'Downloads the selected model once, then transcribes recorded audio on this device.',
  ...
  'settings.openchamber.visual.field.chatWidth': 'Chat Width',
  'settings.openchamber.visual.field.chatWidthAria': 'Chat Width',
  'settings.openchamber.visual.actions.resetChatWidthAria': 'Reset Chat Width',
  ...
  'settings.openchamber.visual.field.showReasoningTracesAria': 'Show Available Reasoning',
  'settings.openchamber.visual.field.showReasoningTraces': 'Show Available Reasoning',
  'settings.openchamber.visual.field.showReasoningTracesTooltip': 'Displays reasoning supplied by the provider. This does not enable reasoning or change reasoning effort. Hosted OpenAI models provide summaries, not raw internal thoughts. Response Style does not affect reasoning availability.',
  ...
  'settings.magicPrompts.page.group.gitCommitGenerate.description': 'Prompts used for non-mutating commit plan previews: visible user message + hidden instructions.',
