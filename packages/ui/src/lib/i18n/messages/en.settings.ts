export const settingsDict = {
  ...
  'settings.openchamber.tunnel.note.managedRemoteDirectLogin': 'Managed Remote uses individual account sign-in with Supabase On, or a one-time owner link with Supabase Off.',
  'settings.openchamber.tunnel.note.ownerLink': 'This private link grants full access to your DevRyan workspace. It can be used once within 15 minutes; the session lasts seven days.',
  ...
  'settings.openchamber.tunnel.note.startManagedRemoteDirectLogin': 'Start the managed tunnel, then sign in at its hostname with Supabase On, or use the generated owner link with Supabase Off. Keep DevRyan running while the tunnel is in use.',
