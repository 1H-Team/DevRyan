export const settingsDict = {
  ...
  'settings.bugReports.botAudit.description': 'Review captured diagnostics for production bots.',
  'settings.bugReports.botAudit.empty': 'Bot audit logs are not available yet.',
