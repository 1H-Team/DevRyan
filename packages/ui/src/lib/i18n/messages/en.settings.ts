export const settingsDict = {
  ...
  'settings.bugReports.errors.description': 'Sanitized failures captured from sessions, tools, and DevRyan-managed tasks.',
  ...
  'settings.providers.page.auth.modelsNotReady': 'Credentials were saved, but models for {provider} are not available yet.',
