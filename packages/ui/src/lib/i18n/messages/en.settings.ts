export const settingsDict = {
  ...
  'settings.openchamber.tunnel.diagnostic.managedRemoteOriginMismatch': 'Cloudflare remote ingress for this hostname must route to {origin}. Update the public hostname service in Cloudflare if it points to a different local port.',
