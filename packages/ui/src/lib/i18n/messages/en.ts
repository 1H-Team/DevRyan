...
export const dict = {
  ...
  'chat.toolPart.diffPreviewTruncated': 'Preview truncated',
  'chat.toolPart.downloadFullPatch': 'Download full patch',
  'chat.toolPart.diffDownloadFailed': 'Could not download the patch',
  ...
  'chat.managedTasks.summary.childBlocked': 'Child reports blocked',
  'chat.managedTasks.summary.needsReview': 'Result needs review',
  ...
  'chat.managedTasks.transport.backup': 'Continuing the interrupted task on backup model {model}',
  'chat.managedTasks.transport.continued': 'Continued on {model} · {thinking} after the connection interruption',
  'chat.managedTasks.transport.autoBackup': 'Automatically switch to the configured backup',
  'chat.managedTasks.transport.backupUnavailable': 'No distinct, available backup model is configured. Choose a model to continue.',
  ...
  'bots.sidebar.loadFailed': 'Couldn’t load your Bots. Try again.',
  'bots.sidebar.connectionFailed': 'Live updates are unavailable. Reconnecting…',
  'bots.sidebar.accessDisabled': 'Bot access is disabled for this account.',
  ...
  'bots.runtime.foreignDeployment': 'Bot containers on this computer belong to a different deployment. Keep the data directory and key used by your existing Bots. Reopen that installation, or release the conflicting runtime after its owner has stopped. Stopping containers alone does not change their ownership.',
  ...
  'bots.operations.tab.shared': 'Shared files',
  'bots.chat.computer.using': '{bot} is using the computer',
  'bots.chat.computer.waiting': '{bot} is waiting for computer control',
  'bots.chat.computer.title': 'Shared computer',
  'bots.chat.computer.show': 'Show',
  'bots.chat.computer.hide': 'Hide',
  ...
  'bots.operations.computer.diagnosticSubresourceFailure': 'A page resource could not load.',
  'bots.operations.computer.diagnosticSubresourceFailureHost': 'A page resource could not load from {host}.',
  ...
  'filesView.editor.completeTextUnavailable': 'Read-only: the complete editable text is unavailable.',
  ...
  'terminalView.viewport.scrollbackAria': 'Terminal Scrollback',
  'terminalView.viewport.outputAria': 'Terminal Output',
  ...
  'chat.statusRow.compacting.automatic': 'Automatically compacting context…',
  'chat.statusRow.compacting.manual': 'Compacting context…',
  'chat.compaction.divider.automatic': 'Context automatically compacted',
  'chat.compaction.divider.manual': 'Context compacted',
  ...
  'chat.sessionChanges.toast.partialRevert': 'Chat rewound with file conflicts. Preserved current files: {files}',
  'chat.sessionChanges.toast.partialRedo': 'Chat restored with file conflicts. Preserved current files: {files}',
  ...
  'chat.sessionChanges.error.conflict': 'Files changed after this summary was captured. Review the repository before trying again.',
  'chat.sessionChanges.error.revisionChanged': 'The session summary changed. Reopen it before trying again.',
  'chat.sessionChanges.error.rollbackFailed': 'The restore could not finish or fully roll back. Review the repository before continuing.',
  ...
  'chat.sessionChanges.card.title': 'Edited {files}',
  'chat.sessionChanges.card.reviewChanges': 'Review changes',
  'chat.sessionChanges.card.showMore': 'Show {count} more files',
  'chat.sessionChanges.card.showLess': 'Show less',
  'chat.sessionChanges.loading': 'Loading session changes…',
  'chat.sessionChanges.previousPage': 'Previous',
  'chat.sessionChanges.nextPage': 'Next',
  'chat.sessionChanges.page': 'Page {page}',
  'chat.sessionChanges.filePages': 'Changed file pages',
  'chat.sessionChanges.diffPages': 'Diff pages',
  'chat.sessionChanges.storageUnavailable': 'Changes could not be saved. Check available disk space and storage access.',
  'chat.sessionChanges.captureTimeout': 'Some changes could not be captured before the tool started.',
  ...
  'chat.sessionChanges.editCount': '{count} edits',
  'chat.sessionChanges.segment': 'Edit {edit} of {count}',
  'chat.sessionChanges.previousEdit': 'Previous Edit',
  'chat.sessionChanges.nextEdit': 'Next Edit',
  'chat.sessionChanges.segmentPages': 'Recorded Edits',
  'chat.sessionChanges.segmentedRestore': 'Review these recorded edits individually. A safe whole-session Undo is unavailable.',
  'chat.sessionChanges.restoreUnavailable': 'These edits can be reviewed, but the evidence needed for safe Undo or Redo is unavailable.',
  'chat.sessionChanges.rewound': 'Conversation changes are rewound. Restore the conversation before using session Undo.',
  'chat.sessionChanges.limit': 'Some change details exceed the capture or storage limit.',
  'chat.sessionChanges.incomplete': 'Complete capture records are unavailable for this session.',
  'chat.sessionChanges.repositoryReview': 'Review Repository Changes',
  'chat.sessionChanges.binary': 'Binary',
  'chat.sessionChanges.detailExpired': 'The recorded diff for this revision has expired. Open the latest summary for available details.',
  'chat.sessionChanges.unavailableTitle': 'Session Changes',
  'chat.sessionChanges.diffTitle': 'Session changes: {file}',
  'chat.sessionChanges.diffDescription': 'Recorded changes for this session revision.',
  ...
  'chat.sessionChanges.retry': 'Retry',
  ...
  'chat.modelControls.keyboardHintSelect': '{modifier}1–9 Select',
  'chat.modelControls.legacyModels': 'Legacy Models',
  'chat.modelControls.legacyModelCount': '{count} Models',
  'chat.modelControls.backToProviderModels': 'Back to {provider}',
  ...
  'memoryDebugPanel.streaming.copy.hint': 'Copy exports UI streaming and responsiveness metrics as JSON',
