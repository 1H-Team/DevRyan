...
export const dict = {
  ...
  'contextUsage.window.tokenStatsHelp': 'Provider-reported turn tokens. Full input context includes uncached input, cached input read, and cached input created; cached tokens still occupy the model context window.',
  ...
  'chat.statusRow.actions.viewPlan': 'View Plan',
