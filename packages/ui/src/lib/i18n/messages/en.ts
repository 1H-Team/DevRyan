...
export const dict = {
  ...
  'bots.operations.computer.diagnosticSiteRejection': 'The site returned to verification even though the browser prerequisites are healthy. Retry once, then contact the site’s support if the loop continues.',
