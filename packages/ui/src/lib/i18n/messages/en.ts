...
export const dict = {
  ...
  'chat.managedTasks.summary.recovering': 'Recovering...',
  ...
  'chat.managedTasks.providerLimit.recovering': '{provider} rate limit reached for {failedModel}. Recovering with {recoveryModel}…',
  'chat.managedTasks.providerLimit.recovered': 'Recovered from the {provider} rate limit with {recoveryModel}.',
  'chat.managedTasks.providerLimit.recoveryFailed': '{provider} rate limit reached for {failedModel}. Automatic recovery did not complete.',
