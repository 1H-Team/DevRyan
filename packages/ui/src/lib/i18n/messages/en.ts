...
export const dict = {
  ...
  'bots.chat.failure.authentication': 'The Bot provider connection needs attention before this request can run.',
  ...
  'bots.chat.failure.retryFailed': 'The retry could not be started. Try again.',
  ...
  'bots.operations.computer.notRecorded': 'Live diagnostic · frames are never recorded',
  ...
  'gitView.pr.list.description': 'Open, merged, and closed pull requests',
