...
## Flow
Usage data is fetched and normalized, then exposed to charts/sections. z.ai, Kimi, Codex, xAI, and DeepSeek receive the same normalized server/VS Code shape from `@openchamber/shared-runtime`.
