...
- Archived groups are collapsed by default on cold load/refresh, reveal automatically when a user just archived a session into them, and support bulk deletion at group/folder level.
