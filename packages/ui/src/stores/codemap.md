...
- **Managed authentication recovery**: `useManagedOrchestrationStore.ts` accepts host-classified authentication failures from events and snapshots, replacing startup state and indexing the failed child for immediate Model Recovery.
