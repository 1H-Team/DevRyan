...
- **Simplified Bot settings**: `src/components/sections/bots/BotEditor.tsx` owns Overview, Resources, Memory, Members, Routines, and Lifecycle. Resources combines persistent computer files, optional on-demand Skills/SOPs, protected provider credentials, and environment secrets; Bot MCP configuration is absent.
