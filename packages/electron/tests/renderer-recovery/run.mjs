...
const cacheRoot = path.join(repositoryRoot, '.cache/renderer-recovery');
...
try {
  ...
  environment.DEVRYAN_RENDERER_RECOVERY_ROOT = temporaryRoot;
  environment.DEVRYAN_RENDERER_RECOVERY_RESULT = resultPath;
