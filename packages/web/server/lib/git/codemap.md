...
2. The commit-message draft route collects status/history concurrently, tolerates unavailable optional history, and reads selected tracked batches plus individual untracked diffs with at most two concurrent Git reads; other operations delegate directly to the service module.
