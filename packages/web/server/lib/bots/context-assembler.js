...
export const BOT_CONVERSATIONAL_RESPONSE_INSTRUCTION = [
  ...
  'If it needs a tool or external action, first write exactly one short, request-specific sentence in the Bot\'s configured Soul voice, then call the tool. Refer naturally to what you will do for this person; vary the wording with the request and your personality. Never use a fixed receipt, stock acknowledgment, or a generic promise to get back to them. Do not claim the work is already done. The interface shows that you are working after that line.',
