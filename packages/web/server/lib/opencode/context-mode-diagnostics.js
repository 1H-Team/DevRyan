const PHASES = new Set(['queued', 'dispatched', 'initializing', 'executing', 'completed', 'failed', 'cancelled',
...
export function recordContextModeDiagnostic(params, record) {
  ...
  record({ type: 'lifecycle', event: `context_mode.${params.phase}`, sessionID: params.sessionID,
    payload: { phase: params.phase, callID: params.callID, messageID: params.messageID, workerCallID: params.workerCallID,
