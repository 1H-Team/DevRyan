...
export const createWebGitAPI = (): GitAPI => ({
  ...
  generateCommitMessageDraft: gitApiHttp.generateCommitMessageDraft,
  ...
  getGitWorktreeBootstrapOperation: gitApiHttp.getGitWorktreeBootstrapOperation,
  listActiveGitWorktreeBootstrapOperations: gitApiHttp.listActiveGitWorktreeBootstrapOperations,
  retryGitWorktreeBootstrapOperation: gitApiHttp.retryGitWorktreeBootstrapOperation,
  previewGitWorktree: gitApiHttp.previewGitWorktree,
  ...
  computeIntegratePlan: gitApiHttp.computeIntegratePlan,
  integrateCommits: gitApiHttp.integrateCommits,
  isIntegrateInProgress: gitApiHttp.isIntegrateInProgress,
  getIntegrateConflictDetails: gitApiHttp.getIntegrateConflictDetails,
  abortIntegrate: gitApiHttp.abortIntegrate,
  continueIntegrate: gitApiHttp.continueIntegrate,
  ...
  worktree: {
    ...
    operation: gitApiHttp.getGitWorktreeBootstrapOperation,
    activeOperations: gitApiHttp.listActiveGitWorktreeBootstrapOperations,
    retry: gitApiHttp.retryGitWorktreeBootstrapOperation,
